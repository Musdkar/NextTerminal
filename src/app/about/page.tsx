        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {techStack.map((tech, index) => (
              <div
                key={index}
                className="px-4 py-3 bg-surface border border-border rounded-md hover:border-accent/50 transition-colors"
              >
                {tech}
              </div>
            ))}
        ...
        <div className="mb-12">
          ...
          <div className="space-y-3">
            <Link
              ...
              className="flex items-center p-3 bg-surface border border-border rounded-md hover:border-accent hover:bg-surface/80 transition-colors group"
            >
              <svg
                ...
                className="mr-3 text-text-secondary group-hover:text-accent transition-colors"
              >
                <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
              </svg>
              <span className="text-text">GitHub</span>
              <span className="ml-auto text-text-secondary group-hover:text-accent transition-colors">@username</span>
            </Link>
            ...
            >
              ...
              <span className="ml-auto text-text-secondary group-hover:text-accent transition-colors">your.email@example.com</span>
            </Link>
          </div>
        </div>
        
        {/* Footer Note */}
        <div className="text-center text-text-secondary text-sm pt-8 border-t border-border/50">
